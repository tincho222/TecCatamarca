...
router.get(
  "/getTechnicalProfiles/:page?",
  /* check.auth, */ technicalContoller.getTechnicalProfiles
);
router.post(
  "/createTechnical",
  [check.auth, uploads.single("file0")],
  technicalContoller.createTechnicalProfile
);
router.get(
  "/getTechnicalProfileById/:id",
  /* check.auth, */ 
  technicalContoller.getTechnicalProfileById
);
router.put(
  "/updateTechnicalProfile/:id"
  ,   [/* check.auth, */ uploads.single("file0")],
  technicalContoller.updateTechnicalProfile
);
router.delete(
  "/deleteTechnicalProfile/:id",
  check.auth,
  technicalContoller.deleteTechnicalProfile
);
router.post(
  "/uploadTechnicalProfile",
  [check.auth, uploads.single("file0")],
  technicalContoller.uploadTechnicalProfile
);
